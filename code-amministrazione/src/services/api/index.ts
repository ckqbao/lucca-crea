...
export const api = createApi({
  ...
  tagTypes: [...cacher.defaultTags, 'Entrance', 'Pavilion', 'Slide', 'User'],
  endpoints: (builder) => ({
    ...
    getChartData: builder.query<GraphData, void>({
      query: () => ({
        url: `/data/data/graph`,
        method: 'GET',
      }),
...
export const { useGetDataTimingsQuery, useGetChartDataQuery } = api

...
const pavilionApi = api.injectEndpoints({
  endpoints: (builder) => ({
...
export const { useAddPavilionMutation, useGetPavilionsListQuery, useEditPavilionMutation, useDeletePavilionMutation } = pavilionApi
